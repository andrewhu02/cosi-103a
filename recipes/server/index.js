...
// let recipes = [
//   { id: 1, title: 'Halal Guys Chicken and Rice', description: 'A delicious street food dish from NYC.', imageSrc: 'img/food/chickenandrice.jpg', ingredients: ["2 lbs chicken thighs", "1/4 cup olive oil", "2 tablespoons lemon juice"], cookingInstructions: ['Cut the chicken beforehand to cook it more evenly and avoid staining the cutting board', 'In a bowl, add the olive oil, lemon juice, vinegar, garlic cloves, all the spices, and the salt and pepper for a chicken marinade.'], url: '/recipe1'},
